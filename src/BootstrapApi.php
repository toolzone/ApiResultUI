...
use ApiResult\lib\Tools;

/**
 * BootstrapAPI文档生成
 * Class BootstrapApiResult
 * @package ApiResult
 */
class BootstrapApiResult extends ApiResult
{
    /**
    ...
    public function getHtml($type = \ReflectionMethod::IS_PUBLIC) {
        ...
        <head>
            ...
            <title>API文档 By ApiResultUI</title>
            {$this->customCss}
        </head>
        <body>
        <div class="container-fluid">
             ...
             <div class="row">
                    <div class="col-lg-12 text-center copyright-content">
                        Copyright  2019 <a href="http://www.">小强IT屋</a> 版权所有
                    </div>
                </div>
        </div>
        {$this->customJs}
